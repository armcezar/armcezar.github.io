...
// Redirect Preview Work
var overlayPreview = document.querySelector('.overlay');

function overlayRedirect() {
  window.location.assign("project.html")
};
overlayPreview.addEventListener("click", overlayRedirect);

var overlayPreview = document.querySelector('.overlay2');
...
var overlayPreview = document.querySelector('.overlay3');
...
var overlayPreview = document.querySelector('.overlay4');
...
var overlayPreview = document.querySelector('.overlay5');
...
var overlayPreview = document.querySelector('.overlay6');
